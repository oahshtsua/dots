...
local hi_groups = {
	...
	Keyword = { fg = palette.tx, bold = true }, --   any other keyword
	...
	DiagnosticErrorStatusLine = { bg = palette.ui_2, fg = palette.re_600 }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
	DiagnosticWarnStatusLine = { bg = palette.ui_2, fg = palette.ye_600 }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
	DiagnosticInfoStatusLine = { bg = palette.ui_2, fg = palette.cy_600 }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
	DiagnosticHintStatusLine = { bg = palette.ui_2, fg = palette.bl_600 }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
	DiagnosticOk = { fg = palette.gr_600 }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
	...
	SpellBad = { undercurl = true, sp = palette.re_600 },
	SpellCap = { undercurl = true, sp = palette.ye_600 },
	SpellRare = { undercurl = true, sp = palette.cy_600 },
	SpellLocal = { undercurl = true, sp = palette.gr_600 },
	...
	Folded = { bg = palette.bg_2 },

	GitConflictCurrent = { bg = "#C2D8EA" },
	GitConflictIncoming = { bg = "#DAE3B5" },
	GitConflictAncestor = { bg = palette.ui_2 },
